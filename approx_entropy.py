...
if __name__ == '__main__':
    ...
    print("test_lcg: ", approximate_entropy_test(terms_lcg, True), "\n\n")
    print("test_bbs: ", approximate_entropy_test(terms_bbs, True), "\n\n")
    #print("test_ansi: ", approximate_entropy_test(terms_ansi, True), "\n\n")
